...
contract Token is ERC20, Ownable {
    ...
    constructor(
        ...
        uint256[3] memory _feeamountsBuy,
        uint256[3] memory _feeamountsSell,
        address _marketingWallet
    ) ERC20(_tokenName, _tokenSymbol, _decimals) {
        // buy fees set
        marketingFeeBuy = _feeamountsBuy[0];
        liquidityFeeBuy = _feeamountsBuy[1];
        txFeeBuy = _feeamountsBuy[2];
        totalFeeBuy = _feeamountsBuy[0] + _feeamountsBuy[1] +  _feeamountsBuy[2];

        // sell fees set 
        marketingFeeSell = _feeamountsSell[0];
        liquidityFeeSell= _feeamountsSell[1];
        txFeeSell = _feeamountsSell[2];
        totalFeeSell = _feeamountsSell[0] + _feeamountsSell[1] +  _feeamountsSell[2];
    ...
    function _TokenTransfer(
        ...
        bool shouldTakeFee = (!isExemptedFromFee[sender] &&
            !isExemptedFromFee[recipient]) && launched();
        uint256 side = 0;
    ...
    function swapBack() internal isSwapping {
        ...
        _transfer(address(this), marketingWallet, amountOfTokenMarketing);
    ...
    function setBuyFees(
        ...
        txFeeBuy = _txFee;
        totalFeeBuy = _liquidityFee + _marketingFee + _txFee;
    }
    ...
    function setSellFees(
        ...
        totalFeeSell = _liquidityFee + _marketingFee + _txFee;
    }

    function setFeeReceivers(address _marketingWallet, address _devWallet)
        external
        onlyOwner
    {
        marketingWallet = _marketingWallet;
